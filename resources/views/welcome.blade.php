          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                  <h5>Seja Bem vindo A luz e Arte</h5>
                  <p>Encontre As Melhores Solucoes para os Seus Eventos </p>
                </div>
              </div>
              <div class="carousel-item">
                <img src="assets/12.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Seja Bem vindo A luz e Arte</h5>
                  <p>Encontre As Melhores Solucoes para os Seus Eventos</p>
                </div>
          ...
          <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Luz e 𝔸𝕣𝕥𝕖 𝔻𝕖𝕔𝕠𝕣𝕒çã𝕠 𝕖 𝕖𝕧𝕖𝕟𝕥𝕠𝕤.</h5>
                      <p class="card-text">
   Event planner
                ...
                <div class="col-sm-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text">Estacionamento
Reservas
Cartão de Crédito
Acessibilidade e Mobilidade para Todos</p>
                ...
                <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <h5 class="card-title">Luz e 𝔸𝕣𝕥𝕖 𝔻𝕖𝕔𝕠𝕣𝕒çã𝕠 𝕖 𝕖𝕧𝕖𝕟𝕥𝕠𝕤.</h5>
                        <p class="card-text"> Event planner
  📌08:00 até 17:00 (dias úteis);
 📌Decoração e Gestão de eventos;
 📍Localizados em Maputo, Moçambique</p>
