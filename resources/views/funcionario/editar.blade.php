...
<div class="container-fluid px-4">
    <div class="row my-5">
            <form action="/funcionario/{{$funcionario->id}}/update" method="POST">
                @csrf
                @method('PUT')
          <div id="error">
          ...
          <input type="text" value="{{$funcionario->name}}" name="name" id="name" class="form-control form-control-sm">
          <label for="email"class="form-label mt-1">Email <span class="text-danger">*</span></label>
          <input type="email" value="{{$funcionario->email}}" name="email" id="email" class="form-control form-control-sm">
          <label for="nr_bi"class="form-label mt-1">Número de BI <span class="text-danger"></span></label>
          <input type="text" value="{{$funcionario->nr_bi}}" name="nr_bi" id="nr_bi" class="form-control form-control-sm">
          <label for="nr_bi"class="form-label mt-1">Contacto<span class="text-danger"></span></label>
          <input type="text" value="{{$funcionario->contacto}}" name="contacto" id="contacto" class="form-control form-control-sm">
          ...
          <select value="{{$funcionario->permission}}" name="permissao" id="permissao" class="form-select form-select-sm">
            <option value=""></option>
